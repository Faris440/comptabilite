...
const options = {
  scales: {
    yAxes: [
       { 
           stacked: true,  
           ticks: { fontSize: 6, lineHeight: 3, fontColor: "#adb5bd" }, 
